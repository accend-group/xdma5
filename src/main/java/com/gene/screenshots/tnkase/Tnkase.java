...
public class Tnkase extends SeleniumHeadless {
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            driver.findElement(By.name("firstname")).sendKeys("marwin");
            driver.findElement(By.name("lastname")).sendKeys("nicolas");
            ...
            driver.findElement(By.name("institution")).sendKeys("accend");
            driver.findElement(By.name("address")).sendKeys("CA");
            driver.findElement(By.name("city")).sendKeys("CA");
            driver.findElement(By.name("state")).click();
            Thread.sleep(500);
            driver.findElement(By.xpath("//*[@id='state']/option[2]")).click();
            driver.findElement(By.name("zip")).sendKeys("90001");
            driver.findElement(By.name("area")).sendKeys("800");;
            driver.findElement(By.name("exch")).sendKeys("815");
            driver.findElement(By.name("phone")).sendKeys("9507");
            driver.findElement(By.name("email")).sendKeys("marwin@accendgroup.com");
