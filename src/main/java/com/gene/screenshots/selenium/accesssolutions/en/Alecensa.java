...
public class Alecensa extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            driver.findElement(By.className("start-over")).click();
            jse.executeScript("window.scrollTo(0, 0)");
            full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), new Long(1500));
            //driver.findElement(By.linkText("How do I enroll?")).click();
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;

            jse.executeScript("window.scrollTo(0, 0)");
            full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step2", driver.findElement(By.linkText("What will we find out?")), new Long(1500));
            //driver.findElement(By.linkText("What will we find out?")).click();
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);

            jse.executeScript("window.scrollTo(0, 0)");
            full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step3", driver.findElement(By.linkText("What options are there?")), new Long(1500));

            //driver.findElement(By.linkText("What options are there?")).click();
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1500L);
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-1.0-GATCF-1");
            ...
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[2]")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-1.0-GATCF-2");
            ...
            full(driver, false, savePath, "accesssolutions-patient-mobile-alecensa-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), new Long(1500));
            //driver.findElement(By.linkText("How do I enroll?")).click();
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;

            jse.executeScript("window.scrollTo(0, 0)");
            full(driver, false, savePath, "accesssolutions-patient-mobile-alecensa-1.0-step2", driver.findElement(By.linkText("What will we find out?")), new Long(1500));
            //driver.findElement(By.linkText("What will we find out?")).click();
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-alecensa-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);

            jse.executeScript("window.scrollTo(0, 0)");
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-1.0-step3", driver.findElement(By.linkText("What options are there?")), new Long(1500));
            ...
            movecursorm(driver);
            //Thread.sleep(1500);
            //full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;

            jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What will we find out?")).click();
            //Thread.sleep(1500);
            //full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);

            jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What options are there?")).click();
            //Thread.sleep(1500);
            //full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1500L);
            ...
            driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div[1]/a")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-2.0-more-info-1");
            ...
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab1");

            driver.findElement(By.xpath("//*[@id='accordion_0']/div/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab2");

            driver.findElement(By.xpath("//*[@id='accordion_1918003580']/div[1]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab3");

            driver.findElement(By.xpath("//*[@id='accordion_1918003580']/div[2]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab4");

            driver.findElement(By.xpath("//*[@id='accordion_2']/div[1]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab5");

            driver.findElement(By.xpath("//*[@id='accordion_2']/div[2]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab6");

            driver.findElement(By.xpath("//*[@id='accordion_2']/div[3]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab7");

            driver.findElement(By.xpath("//*[@id='accordion_3']/div[1]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab8");

            driver.findElement(By.xpath("//*[@id='accordion_3']/div[2]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab9");

            driver.findElement(By.xpath("//*[@id='accordion_3']/div[3]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab10");

            driver.findElement(By.xpath("//*[@id='accordion_4']/div[1]/div[1]")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-3.0-tab11");
            ...
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-pat1-no");
            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.className("start-over")).click();
            ...
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[1]/a")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-pat-more-info-1");

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-pat-2");
            Thread.sleep(500);
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();
            ...
            driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[1]/a")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-alecensa-pat-more-info-2");
