...
public class Pegasys extends SeleniumTest {
...
full(driver, true, savePath, "accesssolutions-patient-pegasys-1.0-GATCF-2");
			...
			Thread.sleep(1000);
full(driver, true, savePath, "accesssolutions-patient-pegasys-1.0-step1");

			jse.executeScript("window.scrollTo(0, 0)");
			driver.findElement(By.linkText("What will we find out?")).click();
			Thread.sleep(1000);
full(driver, true, savePath, "accesssolutions-patient-pegasys-1.0-step2");
...
full(driver, false, savePath, "accesssolutions-mobile-patient-pegasys-1.0-GATCF4-no");
			...
			movecursorm(driver);
			Thread.sleep(1000);
full(driver, false, savePath, "accesssolutions-mobile-patient-pegasys-1.0-step1");

			jse.executeScript("window.scrollTo(0, 0)");
			driver.findElement(By.linkText("What will we find out?")).click();
			Thread.sleep(1000);
full(driver, false, savePath, "accesssolutions-mobile-patient-pegasys-1.0-step2");
