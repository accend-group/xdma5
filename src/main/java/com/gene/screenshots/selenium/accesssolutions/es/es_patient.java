...
//		screenshots.visible(driver, true, savePath,   "accesssolutions-patient-select-treatment");
		...
		screenshots.full(driver, true, savePath,  "accesssolutions-patient-pan-popup-1");
		
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div[2]/div/div/div[2]/div/div[3]/div[1]/a")).click();
		screenshots.full(driver, true, savePath,  "accesssolutions-patient-pan-popup-2");
		
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div[2]/div/div[1]/a")).click();
		screenshots.full(driver, true, savePath,  "accesssolutions-patient-pan-popup-3");
