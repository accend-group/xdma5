...
public class es_esbriet {
	...
	public static void main(String[] args, WebDriver driver) throws InterruptedException {
        ...
        String savePath = Variables.getSavePath() + "/desktop/es/esbriet";
	...
	public static void esbriet_mobile(WebDriver driver) throws InterruptedException{
        String savePath = Variables.getSavePath() + "/mobile/es/esbriet";
