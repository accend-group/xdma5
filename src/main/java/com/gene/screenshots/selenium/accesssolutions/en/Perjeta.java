...
public class Perjeta extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            Thread.sleep(1000);
            full(driver, true, savePath, "accesssolutions-patient-perjeta-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1000L);;

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What will we find out?")).click();
            Thread.sleep(1000);
            full(driver, true, savePath, "accesssolutions-patient-perjeta-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1000L);

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What options are there?")).click();
            Thread.sleep(1000);
            full(driver, true, savePath, "accesssolutions-patient-perjeta-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1000L);
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            movecursorm(driver);
            Thread.sleep(1000);
            full(driver, false, savePath, "accesssolutions-mobile-patient-perjeta-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1000L);;

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What will we find out?")).click();
            Thread.sleep(1000);
            full(driver, false, savePath, "accesssolutions-mobile-patient-perjeta-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1000L);

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What options are there?")).click();
            Thread.sleep(1000);
            full(driver, false, savePath, "accesssolutions-mobile-patient-perjeta-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1000L);
