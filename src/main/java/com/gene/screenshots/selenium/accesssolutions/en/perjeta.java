...
public class perjeta {
    ...
    public static void setScreenshots(Screenshots screenshots){
        perjeta.screenshots = screenshots;
    }
	...
	public static void main(String[] args, WebDriver driver) throws InterruptedException {
        ...
        String savePath = Variables.getSavePath() + "/desktop/en/perjeta";
		...
		screenshots.full(driver, true, savePath,   "accesssolutions-patient-perjeta-site-map");
	}
	public static void perjeta_mobile(WebDriver driver) throws InterruptedException{
		// TODO Auto-generated method stub
		JavascriptExecutor jse = (JavascriptExecutor)driver;

        String savePath = Variables.getSavePath() + "/mobile/en/perjeta";
		...
		Thread.sleep(500);
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-1.0-GATCF1-yes");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-1.0-GATCF3-yes");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-1.0-GATCF4-yes");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.className("start-over")).click();
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-1.0-GATCF1-no");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-1.0-GATCF2-no");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-1.0-GATCF3-no");
		...
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,    "accesssolutions-mobile-patient-perjeta-1.0-GATCF2-yes");
		...
		screenshots.full(driver, true, savePath,    "accesssolutions-mobile-patient-perjeta-1.0-GATCF4-no");
		...
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat1-no");
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.className("start-over")).click();

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat1-yes");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat2-no");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat2-yes");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat3-yes");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat3-no");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat4-yes");

		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-pat4-no");

		driver.get("http://localhost:4503/content/accesssolutions-site/en_us/patient/brands/perjeta/search.html");
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-search");

		driver.get("http://localhost:4503/content/accesssolutions-site/en_us/patient/brands/perjeta/site-map.html");
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-perjeta-site-map");
	}
