...
public class es_rituxan_nhl_cll {
	...
	public static void rituxan_nhl_cll_mobile(WebDriver driver) throws InterruptedException{
        String savePath = Variables.getSavePath() + "/mobile/es/rituxan_nhl_cll";
