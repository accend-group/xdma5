...
public class rituxanhycela {
    ...
    public static void setScreenshots(Screenshots screenshots){
        rituxanhycela.screenshots = screenshots;
    }
	...
	public static void main(String[] args, WebDriver driver) throws InterruptedException {
        ...
        String savePath = Variables.getSavePath() + "/desktop/en/rituxanhycela";
	...
	public static void rituxanhycela_mobile(WebDriver driver) throws InterruptedException{
        ...
        String savePath = Variables.getSavePath() + "/mobile/en/rituxanhycela";
