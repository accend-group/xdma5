...
public class venclexta {
	...
	public static void venclexta_mobile(WebDriver driver) throws InterruptedException{
        ...
        String savePath = Variables.getSavePath() + "/mobile/en/venclexta";
