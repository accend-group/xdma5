...
public class rituxan_nhl_cll {
	...
	public static void rituxan_nhl_cll_mobile(WebDriver driver) throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[1]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF1-yes");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[1]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF3-yes");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF4-yes");
		...
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF1-no");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF2-no");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF3-no");
		...
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[1]")).click();
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF2-yes");
		...
		movecursorm(driver);
		screenshots.full(driver, savePath,    "accesssolutions-mobile-patient-rituxan-nhl-cll-1.0-GATCF4-no");
		...
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat1-no");
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.className("start-over")).click();
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat1-yes");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat2-no");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat2-yes");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat3-yes");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat3-no");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat4-yes");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[5]/div[2]/button")).click();
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[2]")).click();
		screenshots.full(driver, savePath,   "accesssolutions-mobile-patient-rituxan-nhl-cll-pat4-no");
