...
public class Herceptin extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            //full(driver, true, savePath, "accesssolutions-patient-herceptin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;*/
            full(driver, true, savePath, "accesssolutions-patient-herceptin-1.0-step1", driver.findElement(By.linkText(textFromLink)), 1500L);
            ...
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-herceptin-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);
            full(driver, true, savePath, "accesssolutions-patient-herceptin-1.0-step2", driver.findElement(By.linkText(textFromLink)), 1500L);

            /*jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What options are there?")).click();
            Thread.sleep(1500);
            full(driver, true, savePath, "accesssolutions-patient-herceptin-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1500L);*/
            full(driver, true, savePath, "accesssolutions-patient-herceptin-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1500L);
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-herceptin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;*/
            full(driver, false, savePath, "accesssolutions-mobile-patient-herceptin-1.0-step1", driver.findElement(By.linkText(textFromLink)), 1500L);
            ...
            //driver.findElement(By.linkText("What we find out")).click();
            //Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-herceptin-1.0-step2", driver.findElement(By.linkText(textFromLink)), 1500L);

            /*jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What options are there?")).click();
            Thread.sleep(1500);*/
            textFromLink = "What options are there?";
            full(driver, false, savePath, "accesssolutions-mobile-patient-herceptin-1.0-step3", driver.findElement(By.linkText(textFromLink)), 1500L);
