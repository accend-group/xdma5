...
public class Tecentriq extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            getScreenshotForAccordion(driver, "accesssolutions-patient-tecentriq-1.0", savePath, true);
            ...
            getScreenshotForAccordion(driver, "accesssolutions-patient-tecentriq-3.0", savePath, true);
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            getScreenshotForAccordion(driver, "accesssolutions-mobile-patient-tecentriq-1.0", savePath, false);
...
//		jse.executeScript("arguments[0].setAttribute('style', 'padding-bottom:0px;')",element);
            ...
            getScreenshotForAccordion(driver, "accesssolutions-mobile-patient-tecentriq-3.0", savePath, false);
