...
public class Avastin extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), new Long(1500));
            //driver.findElement(By.linkText("How do I enroll?")).click();
            //movecursor1(driver);
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;

            //jse.executeScript("window.scrollTo(0, 0)");

            full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step2", driver.findElement(By.linkText("What will we find out?")), new Long(1500));
            //driver.findElement(By.linkText("What will we find out?")).click();
            //movecursor1(driver);
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);

            full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step3", driver.findElement(By.linkText("What options are there?")), new Long(1500));
            //jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What options are there?")).click();
            //movecursor1(driver);
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1500L);
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            full(driver, false, savePath, "accesssolutions-patient-mobile-avastin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), new Long(1500));
            //driver.findElement(By.linkText("How do I enroll?")).click();
            //movecursor1(driver);
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;
            ...
            full(driver, false, savePath, "accesssolutions-mobile-patient-avastin-1.0-step2", driver.findElement(By.linkText("What will we find out?")), new Long(1500));
            //driver.findElement(By.linkText("What will we find out?")).click();
            //movecursor1(driver);
            //Thread.sleep(1500);
            //full(driver, true, savePath, "accesssolutions-patient-avastin-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);

            full(driver, false, savePath, "accesssolutions-mobile-patient-avastin-1.0-step3", driver.findElement(By.linkText("What options are there?")), new Long(1500));
            //jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What options are there?")).click();
            //movecursor1(driver);
            //Thread.sleep(1500);
           ...
           /*movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-avastin-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What will we find out?")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-avastin-1.0-step2", driver.findElement(By.linkText("What will we find out?")), 1500L);

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What options are there?")).click();
            movecursorm(driver);
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-avastin-1.0-step3", driver.findElement(By.linkText("What options are there?")), 1500L);*/
