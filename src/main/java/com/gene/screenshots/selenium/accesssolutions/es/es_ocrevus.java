...
public class es_ocrevus {
	...
	public static void main(String[] args, WebDriver driver) throws InterruptedException {
		...
		screenshots.full(driver, true, savePath,   "accesssolutions-patient-ocrevus-sitemap");
	}
...
//		jse.executeScript("arguments[0].setAttribute('style', 'padding-bottom:0px;')",element);
		...
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/ocrevus/site-map.html");
		screenshots.full(driver, true, savePath,   "accesssolutions-mobile-patient-ocrevus-sitemap");
	}
