...
public class Actemra extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            full(driver, true, savePath, "accesssolutions-patient-actemra-1.0-step1", driver.findElement(By.xpath("//*[@id=\"callout_v2\"]/p[2]/a")), new Long(1500));//driver.findElement(By.linkText("How do I enroll?")), new Long(1500));
            //driver.findElement(By.linkText("How do I enroll?")).click();

            //full(driver, true, savePath, "accesssolutions-patient-actemra-1.0-step1", driver.findElement(By.linkText("How do I enroll?")), 1500L);;
            jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What will we find out?")).click();
            //Thread.sleep(1500);
            full(driver, true, savePath, "accesssolutions-patient-actemra-1.0-step2", driver.findElement(By.linkText("What will we find out?")), new Long(1500));

            jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What options are there?")).click();
            Thread.sleep(1500);
            full(driver, true, savePath, "accesssolutions-patient-actemra-1.0-step3", driver.findElement(By.linkText("What options are there?")), new Long(1500));
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            full(driver, false, savePath, "accesssolutions-mobile-patient-actemra-1.0-step1", driver.findElement(By.xpath("//*[@id=\"callout_v2\"]/p[2]/a")), new Long(1500));//driver.findElement(By.linkText("How do I enroll?")), new Long(1500));

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("What will we find out?")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-actemra-1.0-step2", driver.findElement(By.linkText("What will we find out?")), new Long(1500));

            jse.executeScript("window.scrollTo(0, 0)");
            //driver.findElement(By.linkText("What options are there?")).click();
            Thread.sleep(1500);
            full(driver, false, savePath, "accesssolutions-mobile-patient-actemra-1.0-step3", driver.findElement(By.linkText("What options are there?")), new Long(1500));
