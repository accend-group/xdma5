...
public class Cotellic extends SeleniumHeadless {
    ...
    public void desktopAutomationTest(String savePath) {
        ...
        try {
            ...
            getScreenshotForAccordion(driver, "accesssolutions-patient-cotellic-1.0", savePath, true);
            ...
            Thread.sleep(1000);
            full(driver, true, savePath, "accesssolutions-patient-cotellic-1.0-step1");

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("�Qu� averiguaremos?")).click();
            Thread.sleep(1000);
            full(driver, true, savePath, "accesssolutions-patient-cotellic-1.0-step2");
            ...
            getScreenshotForAccordion(driver, "accesssolutions-patient-cotellic-3.0", savePath, true);
    ...
    public void mobileAutomationTest(String savePath) {
        ...
        try {
            ...
            getScreenshotForAccordion(driver, "accesssolutions-mobile-patient-cotellic-1.0", savePath, false);
...
//		jse.executeScript("arguments[0].setAttribute('style', 'padding-bottom:0px;')",element);
            movecursorm(driver);
            Thread.sleep(1000);
            full(driver, false, savePath, "accesssolutions-mobile-patient-cotellic-1.0-step1");

            jse.executeScript("window.scrollTo(0, 0)");
            driver.findElement(By.linkText("�Qu� averiguaremos?")).click();
            movecursorm(driver);
            Thread.sleep(1000);
            full(driver, false, savePath, "accesssolutions-mobile-patient-cotellic-1.0-step2");
            ...
            getScreenshotForAccordion(driver, "accesssolutions-mobile-patient-cotellic-3.0", savePath, false);
