	...
	public void desktopAutomationTest(String savePath) {
		...
		WebDriver driver = makeDesktopDriver();
		 ...
		 try {
			...
			Thread.sleep(1000);
			visible(driver, true, savePath, "perjeta-hover-4.0");
			
			driver.findElement(By.className("genentech-component--button"));
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			visible(driver, true, savePath, "perjeta-modal-thirdpartysite");
			...
			Thread.sleep(1000);
			full(driver, true, savePath, "perjeta-4.2-pat1-part2");
			...
			Thread.sleep(1000);
			full(driver, true, savePath, "perjeta-4.2-pat2-part1");
			...
			Thread.sleep(1000);
			full(driver, true, savePath, "perjeta-4.2-pat2-part2");
			...
			Thread.sleep(1000);
			full(driver, true, savePath, "perjeta-4.2-pat3-part1");
	...
	public void mobileAutomationTest(String savePath) {
		 ...
		 WebDriver driver = makeMobileDriver();
		   ...
		   try {
				...
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-navigation");
				
				driver.findElement(By.xpath("/html/body/header/div[1]/div/div[2]/nav/div/div[2]/div/ul/li[1]/a/i")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-hover-1.0");
				
				driver.findElement(By.xpath("/html/body/header/div[1]/div/div[2]/nav/div/div[2]/div/ul/li[2]/a/i")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-hover-2.0");
				
				driver.findElement(By.xpath("/html/body/header/div[1]/div/div[2]/nav/div/div[2]/div/ul/li[3]/a/i")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-hover-3.0");
				
				driver.findElement(By.xpath("/html/body/header/div[1]/div/div[2]/nav/div/div[2]/div/ul/li[4]/a/i")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-hover-4.0");
				
				driver.findElement(By.xpath("/html/body/header/div[1]/div/div[2]/nav/div/div[1]/ul/li[1]/a/span")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-modal-HCP");
				
				goToUrl(driver, "/patient/breast-cancer.html");
				driver.findElement(By.xpath("//*[@id=\"safety_reference_cal_647752441\"]/div/div/div/p/a[2]")).click();
				Thread.sleep(1000);
				visible(driver, false, savePath, "perjeta-modal-thirdpartysite");
				
				goToUrl(driver, "/patient/breast-cancer/about.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-1.0");
				
				goToUrl(driver, "/patient/breast-cancer/about/HER2-positive-breast-cancer.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-1.1");
				
				goToUrl(driver, "/patient/breast-cancer/about/targeted-treatment.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-1.2");
				
				goToUrl(driver, "/patient/breast-cancer/about/perjeta.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-1.3");
				
				goToUrl(driver, "/patient/breast-cancer/early.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-2.0");
				
				goToUrl(driver, "/patient/breast-cancer/early/treatment-before-surgery.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-2.1");
				
				goToUrl(driver, "/patient/breast-cancer/early/how-treatment-is-given.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-2.2");
				
				goToUrl(driver, "/patient/breast-cancer/early/why-perjeta.html");
				full(driver, false, savePath, "perjeta-2.3");
				
				goToUrl(driver, "/patient/breast-cancer/early/talking-with-your-doctor.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-2.4");
				
				goToUrl(driver, "/patient/breast-cancer/metastatic.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-3.0");
				
				goToUrl(driver, "/patient/breast-cancer/metastatic/how-treatment-is-given.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-3.1");
				
				goToUrl(driver, "/patient/breast-cancer/metastatic/why-perjeta.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-3.2");
				
				goToUrl(driver, "/patient/breast-cancer/metastatic/talking-with-your-team.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-3.3");
				
				goToUrl(driver, "/patient/breast-cancer/support-resources.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.0");
				
				goToUrl(driver, "/patient/breast-cancer/support-resources/4HER-patient-support-app.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.1");
				
				goToUrl(driver, "/patient/breast-cancer/support-resources/financial-resources.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2");
				
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-pat1");
				
				driver.findElement(By.className("start-over")).click();
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[1]")).click();
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-pat2");
				...
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-pat3");
				
				driver.findElement(By.className("start-over")).click();
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[1]")).click();
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[2]/div[1]/a")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-pat-q1");
				
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[1]")).click();
				driver.findElement(By.xpath("/html/body/main/section[2]/div/div/div/div/div[2]/div[1]/ul/li[3]/div[1]/a")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-pat-q2");
				
				driver.navigate().refresh();
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[1]/header/h1")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-tab1");
				
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[1]/header/h1")).click();
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[2]/header/h1")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-tab2");
				
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[2]/header/h1")).click();
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[3]/header/h1")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-tab3");
				
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[3]/header/h1")).click();
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[4]/header/h1")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-tab4");
				
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[4]/header/h1")).click();
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[5]/header/h1")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-tab5");
				
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[5]/header/h1")).click();
				driver.findElement(By.xpath("/html/body/main/section[5]/div/div[2]/div/div[2]/section[6]/header/h1")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.2-tab6");
				
				goToUrl(driver, "/patient/breast-cancer/support-resources/herconnection.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.3");
				
				driver.findElement(By.xpath("/html/body/main/section[2]/div[2]/div[1]/div[6]/form/div[2]/ol/li[1]/input")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.3-earlystage");
				
				driver.findElement(By.xpath("/html/body/main/section[2]/div[2]/div[1]/div[6]/form/div[2]/ol/li[2]/input")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.3-metastatic");
...
//				driver.findElement(By.cssSelector("body > main > section.gene-template__content.gene-template__content--main.gene-template__container > div.gene-template__form-main.gene-template__column.gene-template__column--primary > div.gene-template__authoring.gene-template__container.gene-template__container--form-intro > div.perjeta-patient-reg-form.section > form > div:nth-child(9) > div.state-zip-container > div.field.required.state.invalid > div > ul > li:nth-child(1)")).click();
				...
				driver.findElement(By.className("submit")).click();
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.3-submit");
				
				goToUrl(driver, "/patient/breast-cancer/support-resources/support-groups.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.4");
				
				goToUrl(driver, "/patient/breast-cancer/support-resources/download.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-4.5");
				
				goToUrl(driver, "/patient/site-map.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-sitemap");
				
				goToUrl(driver, "/patient/breast-cancer/glossary.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-glossary");
				
				goToUrl(driver, "/patient/breast-cancer/safety.html");
				Thread.sleep(1000);
				full(driver, false, savePath, "perjeta-safety");	
