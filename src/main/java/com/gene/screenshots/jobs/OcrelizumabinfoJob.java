...
import com.gene.screenshots.selenium.ocrevus.Ocrelizumbainfo;

@Job(name = "OcrelizumabInfo", ID = 21, info = "Automated Screenshots for the Ocrelizumb info page")
@Environment(dev = "",
        prod = "https://www.ocrevus.com",
        stage = "",
...
public class OcrelizumbainfoJob extends ScreenshotJob {
    public OcrelizumbainfoJob(){
        setScript(new Ocrelizumbainfo());
    }
}
